...
def data_augmentation(args):
    ...
    params_list = [ 
        ...
        {'is_constractive':True,'with_mask':False,'with_neighborhood':True,'random_select':True,'random_mask':False,'lr':4e-5,'betas' : (0,0),'with_scheduler' : False,'with_bc':True},   # constractive random neighborhood 
    ]
    ...
    for i, params in enumerate(params_list):
        ...
        for k, random_state in enumerate(random_states):
            ...
            if args.dataset == "PubMed20k":
                K_shot_novel = f"data/ag/{args.ag}/PubMed20K/{args.dataset}_novel_few_shot_data{K_shot}_search_{K_shot}_{random_state}.csv"
            else:
